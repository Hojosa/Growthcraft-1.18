...
public class GrowthcraftBambooRecipes extends RecipeProvider{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		ShapelessRecipeBuilder.shapeless(GrowthcraftBambooBlocks.BAMBOO_PLANK_BUTTON.get())
		...
		ShapedRecipeBuilder.shaped(GrowthcraftBambooBlocks.BAMBOO_PLANK_DOOR.get(), 3)
		.pattern("##")
		.pattern("##")
		.pattern("##")
		...
		ShapedRecipeBuilder.shaped(GrowthcraftBambooBlocks.BAMBOO_PLANK_FENCE_GATE.get(), 3)
		.pattern("121")
		.pattern("121")
		...
		ShapedRecipeBuilder.shaped(GrowthcraftBambooBlocks.BAMBOO_PLANK_FENCE.get(), 3)
		.pattern("212")
		.pattern("212")
		.define('1', Items.STICK)
		.define('2', GrowthcraftBambooBlocks.BAMBOO_PLANK.get())
		...
		ShapedRecipeBuilder.shaped(GrowthcraftBambooBlocks.BAMBOO_PLANK_PRESSURE_PLATE.get())
		.pattern("##")
		.define('#', GrowthcraftBambooBlocks.BAMBOO_PLANK.get())
		.group(Reference.MODID)
		.unlockedBy("has_item", InventoryChangeTrigger.TriggerInstance.hasItems(GrowthcraftBambooBlocks.BAMBOO_PLANK.get()))
		...
		ShapedRecipeBuilder.shaped(GrowthcraftBambooBlocks.BAMBOO_PLANK_SLAB.get(), 6)
		.pattern("###")
		.define('#', GrowthcraftBambooBlocks.BAMBOO_PLANK.get())
		.group(Reference.MODID)
		.unlockedBy("has_item", InventoryChangeTrigger.TriggerInstance.hasItems(GrowthcraftBambooBlocks.BAMBOO_PLANK.get()))
		...
		ShapedRecipeBuilder.shaped(GrowthcraftBambooBlocks.BAMBOO_PLANK_STAIRS.get(), 4)
		.pattern("#  ")
		.pattern("## ")
		.pattern("###")
		.define('#', GrowthcraftBambooBlocks.BAMBOO_PLANK.get())
		...
		ShapedRecipeBuilder.shaped(GrowthcraftBambooBlocks.BAMBOO_PLANK_TRAPDOOR.get())
		.pattern("###")
		.pattern("###")
		.define('#', GrowthcraftBambooBlocks.BAMBOO_PLANK.get())
		.group(Reference.MODID)
		...
		ShapelessRecipeBuilder.shapeless(GrowthcraftBambooBlocks.BAMBOO_PLANK.get(), 4)
		...
		ShapedRecipeBuilder.shaped(GrowthcraftBambooBlocks.BAMBOO_PLANK_BEE_BOX.get())
		.pattern("SPS")
		.pattern("PBP")
		.pattern("SPS")
