...
public class GrowthcraftApiaryRecipes extends RecipeProvider{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		ShapedRecipeBuilder.shaped(GrowthcraftApiaryBlocks.BEE_BOX_ACACIA.get())
		.pattern("SPS")
		.pattern("PBP")
		.pattern("SPS")
		...
		ShapedRecipeBuilder.shaped(GrowthcraftApiaryBlocks.BEE_BOX_BIRCH.get())
		.pattern("SPS")
		.pattern("PBP")
		.pattern("SPS")
		...
		ShapedRecipeBuilder.shaped(GrowthcraftApiaryBlocks.BEE_BOX_CRIMSON.get())
		.pattern("SPS")
		.pattern("PBP")
		.pattern("SPS")
		...
		ShapedRecipeBuilder.shaped(GrowthcraftApiaryBlocks.BEE_BOX_DARK_OAK.get())
		.pattern("SPS")
		.pattern("PBP")
		.pattern("SPS")
		...
		ShapedRecipeBuilder.shaped(GrowthcraftApiaryBlocks.BEE_BOX_JUNGLE.get())
		.pattern("SPS")
		.pattern("PBP")
		.pattern("SPS")
		...
		ShapedRecipeBuilder.shaped(GrowthcraftApiaryBlocks.BEE_BOX_OAK.get())
		.pattern("SPS")
		.pattern("PBP")
		.pattern("SPS")
		.define('B', Items.ACACIA_SLAB)
		...
		ShapedRecipeBuilder.shaped(GrowthcraftApiaryBlocks.BEE_BOX_SPRUCE.get())
		.pattern("SPS")
		.pattern("PBP")
		.pattern("SPS")
		...
		ShapedRecipeBuilder.shaped(GrowthcraftApiaryBlocks.BEE_BOX_WARPED.get())
		.pattern("SPS")
		.pattern("PBP")
		.pattern("SPS")
		...
		GrowthcraftApiaryItems.ITEMS.getEntries().forEach(item -> {
			if(item.getId().getPath().contains("bees_wax_")) {
				...
				ShapedRecipeBuilder.shaped(item.get(), 8)
				.pattern("AAA")
				.pattern("ABA")
				.pattern("AAA")
