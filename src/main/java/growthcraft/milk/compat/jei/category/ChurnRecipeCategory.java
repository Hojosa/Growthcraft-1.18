...
public class ChurnRecipeCategory implements IRecipeCategory<ChurnRecipe> {
    ...
    public Component getTitle() {
        return new TranslatableComponent("jei.growthcraft_milk.category.churn");
    }
    ...
    @Override
    public void draw(ChurnRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
