...
public class GrowthcraftMilkItemRenderers {
    ...
    public static void registerItemRenders(ColorHandlerEvent.Item event) {
        ItemRendererUtils.registerItem(event, Reference.FluidColor.BUTTER_MILK.toItemColor(), GrowthcraftMilkFluids.BUTTER_MILK.get().getBucket());
        ItemRendererUtils.registerItem(event, Reference.FluidColor.CHEESE_BASE.toItemColor(), GrowthcraftMilkFluids.CHEESE_BASE.get().getBucket());
        ItemRendererUtils.registerItem(event, Reference.FluidColor.CONDENSED_MILK.toItemColor(), GrowthcraftMilkFluids.CONDENSED_MILK.get().getBucket());
        ItemRendererUtils.registerItem(event, Reference.FluidColor.CREAM.toItemColor(), GrowthcraftMilkFluids.CREAM.get().getBucket());
        ItemRendererUtils.registerItem(event, Reference.FluidColor.CULTURED_MILK.toItemColor(), GrowthcraftMilkFluids.CULTURED_MILK.get().getBucket());
        ItemRendererUtils.registerItem(event, Reference.FluidColor.KUMIS.toItemColor(), GrowthcraftMilkFluids.KUMIS.get().getBucket());
        ItemRendererUtils.registerItem(event, Reference.FluidColor.MILK.toItemColor(), GrowthcraftMilkFluids.MILK.get().getBucket());
        ItemRendererUtils.registerItem(event, Reference.FluidColor.RENNET.toItemColor(), GrowthcraftMilkFluids.RENNET.get().getBucket());
        ItemRendererUtils.registerItem(event, Reference.FluidColor.SKIM_MILK.toItemColor(), GrowthcraftMilkFluids.SKIM_MILK.get().getBucket());
        ItemRendererUtils.registerItem(event, Reference.FluidColor.WHEY.toItemColor(), GrowthcraftMilkFluids.WHEY.get().getBucket());
